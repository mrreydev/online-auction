...
class LelangExport implements FromCollection, ShouldAutoSize, WithHeadings, WithEvents
{
    /**
    ...
    */
    public function collection()
    {
        $query = Lelang::join('barangs', 'lelangs.id_barang', '=', 'barangs.id_barang')
                ...
                ->select('lelangs.id_lelang', 'barangs.nama_barang', 'lelangs.tgl_lelang', 'lelangs.start_lelang', 'lelangs.end_lelang', 'lelangs.harga_akhir', 'masyarakats.nama_lengkap', 'petugas.nama_petugas', 'lelangs.status')->get();
